...
import org.thomasmore.session.WarehouseFacade;
...
public class WarehouseController implements Serializable {
    ...
    @EJB
    private org.thomasmore.session.WarehouseFacade ejbFacade;
    ...
    public Warehouse getWarehouse(java.lang.Integer id) {
